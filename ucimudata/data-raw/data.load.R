...
KVH_1750_IMU_Xgyro = make_wvar_mimu_obj(R1.Xgyro, R2.Xgyro, R3.Xgyro,R4.Xgyro,R5.Xgyro,R6.Xgyro, freq = 100, unit = "Degrees/Sec",
                          sensor.name = "KVH 1750 IMU Gyroscope X-Axis", exp.name = c("16/3/2017 11am", "16/3/2017 2pm",
...
KVH_1750_IMU_Xacc = make_wvar_mimu_obj(R1.Xacc, R2.Xacc, R3.Xacc,R4.Xacc,R5.Xacc,R6.Xacc, freq = 100, unit = "g",
...
KVH_1750_IMU_Yacc = make_wvar_mimu_obj(R1.Yacc, R2.Yacc, R3.Yacc,R4.Yacc,R5.Yacc,R6.Yacc, freq = 100, unit = "g",
...
KVH_1750_IMU_Zacc = make_wvar_mimu_obj(R1.Zacc, R2.Zacc, R3.Zacc,R4.Zacc,R5.Zacc,R6.Zacc, freq = 100, unit = "g",
                                        sensor.name = "KVH 1750 IMU Accelerometer Z-Axis", exp.name = c("16/3/2017 11am", "16/3/2017 2pm",
                                                                                                        "16/3/2017 5pm", "17/3/2017 10am",
                                                                                                        "17/3/2017 2pm", "18/3/2017 12pm"))


KVH1750imuGyro = list(Gyro.X = KVH_1750_IMU_Xgyro,Gyro.Y = KVH_1750_IMU_Ygyro,Gyro.Z = KVH_1750_IMU_Zgyro)

KVH1750imuAcc = list(Acc.X = KVH_1750_IMU_Xacc,Acc.Y = KVH_1750_IMU_Yacc,Acc.Z = KVH_1750_IMU_Zacc)


devtools::use_data(KVH1750imuAcc, overwrite = TRUE)
